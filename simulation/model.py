...
class DomesticHeatingABM(AgentBasedModel):
    def __init__(
        ...
        social_influence_importance: float,
    ):
        ...
        self.social_influence_importance = social_influence_importance
    ...
    def heat_pump_installers(self) -> int:
        ...
        population_scale_factor = (
            self.household_count / SCOTLAND_HOUSEHOLD_COUNT_2019
        )
...
def create_and_run_simulation(
    ...
    model = DomesticHeatingABM(
        ...
        social_influence_importance=social_influence_importance,
    )
